 ...
 *******************************************************************************/
package com.xk5156.imageloader.core.imageaware;
 ...
 * through {@link com.xk5156.imageloader.core.ImageLoader ImageLoader}.
 * It can wrap any Android {@link android.view.View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link com.xk5156.imageloader.core.listener.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
...
public interface ImageAware {
	...
	/**
	 * Returns {@linkplain com.xk5156.imageloader.core.assist.ViewScaleType scale type} which is used for
	 ...
	 * {@link com.xk5156.imageloader.core.listener.ImageLoadingListener#onLoadingCancelled(String,
	 ...
	 * {@linkplain com.xk5156.imageloader.core.DisplayImageOptions.Builder#showImageForEmptyUri(
	 *android.graphics.drawable.Drawable) for empty Uri},
	 * {@linkplain com.xk5156.imageloader.core.DisplayImageOptions.Builder#showImageOnLoading(
	 *android.graphics.drawable.Drawable) on loading} or
	 * {@linkplain com.xk5156.imageloader.core.DisplayImageOptions.Builder#showImageOnFail(
	 *android.graphics.drawable.Drawable) on loading fail}. These drawables can be specified in
	 * {@linkplain com.xk5156.imageloader.core.DisplayImageOptions display options}.<br />
	 * Also can be called in {@link com.xk5156.imageloader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
	 ...
	 * {@link com.xk5156.imageloader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
