...
import com.xk5156.imageloader.core.assist.FailReason;
import com.xk5156.imageloader.core.assist.FlushedInputStream;
import com.xk5156.imageloader.core.assist.ImageSize;
import com.xk5156.imageloader.core.assist.LoadedFrom;
import com.xk5156.imageloader.core.assist.ViewScaleType;
import com.xk5156.imageloader.core.imageaware.ImageAware;
import com.xk5156.imageloader.core.imageaware.ImageViewAware;
import com.xk5156.imageloader.core.imageaware.NonViewAware;
import com.xk5156.imageloader.core.listener.ImageLoadingListener;
import com.xk5156.imageloader.core.listener.ImageLoadingProgressListener;
import com.xk5156.imageloader.core.listener.SimpleImageLoadingListener;
import com.xk5156.imageloader.utils.ImageSizeUtils;
...
public class ImageLoader {
	 ...
	 * @param imageAware {@linkplain com.xk5156.imageloader.core.imageaware.ImageAware Image aware view}
	 ...
	 * @param imageAware {@linkplain com.xk5156.imageloader.core.imageaware.ImageAware Image aware view}
	 *                   which should display image
	 * @param options    {@linkplain com.xk5156.imageloader.core.DisplayImageOptions Options} for image
	 ...
	 * @param progressListener {@linkplain com.xk5156.imageloader.core.listener.ImageLoadingProgressListener
	 *                         Listener} for image loading progress. Listener fires events on UI thread if this method
	 *                         is called on UI thread. Caching on disk should be enabled in
	 *                         {@linkplain com.xk5156.imageloader.core.DisplayImageOptions options} to make
	 *                         this listener work.
	 * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 * @throws IllegalArgumentException if passed <b>imageAware</b> is null
	 */
	 ...
	 * {@link com.xk5156.imageloader.core.imageaware.ImageAware ImageAware}
	 */
	 ...
	 * {@link com.xk5156.imageloader.core.imageaware.ImageAware ImageAware}.
	 *
	 * @param imageAware {@link com.xk5156.imageloader.core.imageaware.ImageAware ImageAware} for
	 ...
	 * {@linkplain com.xk5156.imageloader.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
